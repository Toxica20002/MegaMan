...
public class FirstLoadingPage extends State {
    private BufferedImage bufferedImage;
    protected int round;
    protected long startLoadingPageTime;
    Graphics graphicsPaint;

    public FirstLoadingPage(GamePanel gamePanel, int round) {
        super(gamePanel);
    ...
    public void Render() {
        ...
        Image image = Toolkit.getDefaultToolkit().getImage("data\\firstLoadingPage.png");
        graphicsPaint.drawImage(image, 0, 0, null);
        drawLoadingBar(graphicsPaint);

        //System.out.println(System.currentTimeMillis()-startLoadingPageTime);
